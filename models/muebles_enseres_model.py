...
class Mueble(db.Model):
    ...
    def predecir_valor_ia(self, años: int):
        """
    Predice el valor del bien en X años usando el factor de actualización.
    """
        try:
            return round(self.costo_inicial * (self.factor_de_actualizacion ** años), 2)
        except Exception:
            return 0.0    