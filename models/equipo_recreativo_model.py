...
class Recreativo(db.Model):
    __tablename__ = 'recreativos'
    ...
    @classmethod
    def get_by_id(cls, id_recreativo):
        return cls.query.filter_by(id=id_recreativo).first() 
    @property
    def valor_neto(self):
    ...
    def generar_qr(self):
        ...
        # Construir el diccionario con los datos del vehículo
            ...
            nombre_archivo = f"educativo_{self.id}.png"
